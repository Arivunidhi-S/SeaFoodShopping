                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top;">
                                    <div class="col span_2_of_9">
                                        ...
                                        <asp:Label runat="server" CssClass="ico_discount" ID="lblDiscount"></asp:Label><asp:Label
                                            ...
                                            color: #00C31A;  font-size: 19px;
                                            text-align: center; vertical-align: top;"></asp:Label>
                                        <div class="price">
                                            <p>
                                                Price: <span>
                                                ...
                                                </span>&nbsp;&nbsp;&nbsp; <a class="lblfont" href="#about" data-hover="ABOUT">(View Product
                                                    Details)</a><br />
                                                <%--(GST Included)--%>
                                            </p>
                                        </div>
                                        <div class="available">
                                            ...
                                            <ul>
                                                ...
                                                <li><div style="margin-top:-15px;display:list-item" class=""  > <label class="lblfont"> Quantity:</label>   <asp:TextBox ID="cboQuantity" runat="server" Width="75px" Height="25px" Font-Size="16px" Font-Bold="true" BorderStyle="Solid" style="border-color:#00C31A;padding-left:5px;" onkeyup="checkDec(this);"></asp:TextBox>  (In kgs)
                                                                                             <asp:Button CssClass="enjoy-css" style="margin-top:0px;" ID="button" runat="server" Text="Add to Cart" OnClick="btnAddCart_OnClick" /></div>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <td style="vertical-align: top; float: right;">
                                    <div class="col span_2_of_2">
                                        ...
                                        <div class="fb-page" data-href="https://www.facebook.com/arivunidhis"
                                            data-width="200" data-hide-cover="false" data-show-facepile="false" data-show-posts="false">
                                        </div>
                                    </div>
                                </td>
                            </tr>
