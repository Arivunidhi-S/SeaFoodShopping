        ...
        <div class="main">
            <div class="content">
                <div class="content_top">
                    <div class="heading">
                        <h3>
                            ...
                            <telerik:RadComboBox ID="cboSize" runat="server" DataValueField="Dept_ID" CssClass="textbox"
                                EnableLoadOnDemand="true" AppendDataBoundItems="True" EmptyMessage="Select Size" OnClientLoad="OnClientLoad"
                                OnSelectedIndexChanged="cboSize_SelectedIndexChanged" OnItemsRequested="cboSize_OnItemsRequested"
                                AutoPostBack="true" Style="width: 150px" Visible="false">
                                <Items>
                            ...
                            <telerik:RadComboBox ID="cboProducts" runat="server" DataValueField="Dept_ID" CssClass="textbox"
                                EnableLoadOnDemand="true" AppendDataBoundItems="True" EmptyMessage="Select Brands" OnClientLoad="OnClientLoad"
                                OnSelectedIndexChanged="cboProduct_SelectedIndexChanged" OnItemsRequested="cboProduct_OnItemsRequested"
                    ...
                    <div class="see">
                        <p>
                            <asp:LinkButton ID="myid" runat="server" OnClick="lnkurl_Onclick">See all Products</asp:LinkButton>
                        </p>
                    </div>
                    <div class="clear">
                    </div>
                ...
                <div class="section group">
                    ...
                    <div class="grid_1_of_4 images_1_of_4">
                        ...
                        <div class="price-details">
                           ...
                           { %>
                                    <span class="rupees">RM
                                        <%= dtProductsItems.Rows[aa][2].ToString()%></span>
                                    <% } %>
                                    <% 
                           else
                           { %>
                                    <span class="rupees1">RM</span> <strike>
