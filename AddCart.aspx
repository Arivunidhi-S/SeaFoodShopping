                                    ...
                                    <FormTemplate>
                                        <table cellspacing="2" cellpadding="1" width="100%" border="0">
                                            <tr>
                                                ...
                                                <td align="left">
                                                <asp:TextBox ID="cboQnty1" runat="server" Width="75px" Height="20px" Font-Size="16px" Font-Bold="true" BorderStyle="Solid" style="border-color:#00C31A" onkeyup="checkDec(this);"></asp:TextBox>  (In kgs)
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="text-align: right;" class="lblfont">
                                    ...
                                    <asp:Label class="labelstyle" ID="lblpromotion" runat="server" ForeColor="Green" Font-Bold="true" />
                                    Shipping Amount :
                                    <asp:Label class="labelstyle" ID="lblShippingCost" runat="server" ForeColor="Green"
                                        Font-Bold="true" /><br />
                                    <br />
                                    Grand Total :
                                    <asp:Label class="labelstyle" ID="lblGrandTotal" runat="server" ForeColor="Green" Font-Bold="true" />
                                </div>
                                <br />
                                <div style="text-align: right;">
                                    <span>
                                        <%--<asp:Button ID="button" runat="server" Text="Add to Cart" CssClass="enjoy-css" />--%></span>
                                    <span>&nbsp;&nbsp;
