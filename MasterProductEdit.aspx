                                        ...
                                        <label>
                                            Discount (%)</label></span> <span>
                                                <asp:TextBox ID="txtDiscount" runat="server" MaxLength="2" class="textbox" onkeypress="return onlyNos(event,this);"
                                                    OnTextChanged="txtDiscount_OnTextChanged" AutoPostBack="true"></asp:TextBox></span>
                                </div>
                                <div>
                                    <span>
                                        <label>
                                            Discount Price</label></span> <span>
                                                <asp:TextBox ID="txtDiscountPrice" runat="server" class="textbox" Enabled="false"></asp:TextBox></span>
                                </div>
                            </div>
                        </div>
                        <div class="grid_1_of_3 images_1_of_3">
