        ...
        <div class="main">
           ...
           <%--         <div class="grid_1_of_3 images_1_of_3">
                    ...
                    <div class="news_desc1">
                        ...
                        <p>
                            Customers are requested to follow the below steps for the product return:
                        </p>
                        <p>
                        ...
                        <p>
                           Refund can be processed in case of return or cancellation. For your convenience, we offer different refund options based on your payment method at the time of product purchase.
                        </p>
                        <p>
                        ...
                        <br />
                         ...
                         <tr>
                         <td width="25%" style="font-weight:bold;">Payment Method (during purchase)
                         </td>
                         <td width="25%" style="font-weight:bold;">Refund Method
                         </td>
                         <td width="25%" style="font-weight:bold;">EasyBuyBye processing time (after return or  cancellation has been checked)
                         </td>
                         <td width="25%" style="font-weight:bold;">Bank processing Time (after refund has been processed by EasyBuyBye)
                         </td>
                         </tr>


                         <tr>
                         <td>Credit card/Debit card
                         </td>
                         <td>Credit card
                         </td>
                         <td>1 - 3 working days
                         </td>
                         <td>5 - 15 working days (depending on your bank)
                         </td>
                         </tr>
                         ...
                         <td>Ipay88 reversal refund
                         </td>
                         <td>1 - 3 working days
                         </td>
                         <td>5 – 14 working days (depending on your bank)
                         </td>
                         </tr>
                         </table>

                         
        <%--     <asp:Table ID="Table1" runat="server" CellPadding="10" GridLines="horizontal" HorizontalAlign="Center"  CssClass="Rightborders">
         ...
         <asp:TableCell>TableCell 4</asp:TableCell>
                ...
                <!--  <div class="image group">
                    ...
                    <div class="grid news_desc">
                        ...
                        <h4>
                            Posted on Aug 8th, 2013 by <span><a href="#">Finibus Bonorum</a></span></h4>
                        <p>
                        ...
                        <p>
                            ...
                            exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                            irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                            pariatur <a href="#" title="more">[....]</a></p>
                    </div>
                </div>
                <div class="image group">
                    <div class="grid images_3_of_1">
                    ...
                    <div class="grid news_desc">
                        ...
                        <h4>
                            Posted on Aug 1st, 2013 by <span><a href="#">Finibus Bonorum</a></span></h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                            incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                            exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
