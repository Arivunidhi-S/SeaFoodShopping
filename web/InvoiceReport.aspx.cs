...
public partial class web_InvoiceReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "select InvoiceNo,convert(varchar,CREATED_DATE, 103),OrderNo,OrderName,Address1,Address2,PostCode,City,State,Country,Mobile,Brand,Model,Qnty,DiscountPrice, Qnty*DiscountPrice as totprice,Type,DiscountPromotion,ShippingCost from VW_OrderDetails where RefNo='" + srtParamval1.ToString() + "' and buy=1";
