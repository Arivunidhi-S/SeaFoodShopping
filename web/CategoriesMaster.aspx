...
<body oncontextmenu="return false;"><div class="wrap">
 <div class="header"> 
                ...
                <div class="content">
                    <div>
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowMultiRowEdit="false" OnNeedDataSource="RadGrid1_NeedDataSource"
                            ...
                            OnInsertCommand="RadGrid1_InsertCommand" PagerStyle-Mode="NextPrevNumericAndAdvanced" OnItemDataBound="RadGrid1_OnItemDataBound"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    Categories:<asp:Label ID="Label1" runat="server" Text="*" ForeColor="Red" Visible="true" />
                                                     &nbsp;<img title="You don't use Special Character like ' \ / : * ? ' < > | '"
                                            src="../images/q.jpg" style="float:inherit" alt=""/>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtCategory" runat="server" class="textbox" Text='<%# Eval("Category")%>' onkeyup="checkchar(this);"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
